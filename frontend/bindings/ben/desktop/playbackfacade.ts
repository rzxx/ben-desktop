...
export function ListAlbumAvailabilitySummaries(req: apitypes$0.AlbumAvailabilitySummaryListRequest): $CancellablePromise<apitypes$0.AlbumAvailabilitySummaryItem[]> {
    return $Call.ByID(1745200325, req).then(($result: any) => {
...
export function ListRecordingPlaybackAvailability(req: apitypes$0.RecordingPlaybackAvailabilityListRequest): $CancellablePromise<apitypes$0.RecordingPlaybackAvailability[]> {
    return $Call.ByID(2702225238, req).then(($result: any) => {
...
const $$createType0 = apitypes$0.PlaybackBatchResult.createFrom;
const $$createType1 = apitypes$0.PlaybackRecordingResult.createFrom;
const $$createType2 = apitypes$0.AlbumAvailabilityOverview.createFrom;
const $$createType3 = apitypes$0.PlaybackPreparationStatus.createFrom;
const $$createType4 = apitypes$0.RecordingPlaybackAvailability.createFrom;
const $$createType5 = apitypes$0.RecordingAvailabilityOverview.createFrom;
const $$createType6 = apitypes$0.AlbumAvailabilitySummaryItem.createFrom;
const $$createType7 = $Create.Array($$createType6);
const $$createType8 = apitypes$0.RecordingAvailabilityItem.createFrom;
const $$createType9 = $Create.Array($$createType8);
const $$createType10 = $Create.Array($$createType4);
const $$createType11 = apitypes$0.PlaybackResolveResult.createFrom;
const $$createType12 = desktopcore$0.JobSnapshot.createFrom;
