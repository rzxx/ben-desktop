    ...
    return (
      <Toast.Root
        ...
        className={[
          ...
          "data-[starting-style]:[transform:translateX(-50%)_translateY(-100%)_scale(0.9)] data-[starting-style]:opacity-0",
          "data-[ending-style]:opacity-0",
          "data-[expanded]:[transform:translateX(calc(-50%_+_var(--toast-swipe-movement-x)))_translateY(var(--offset-y))]",
          "[&[data-ending-style]:not([data-limited]):not([data-swipe-direction])]:[transform:translateX(-50%)_translateY(-150%)_scale(0.9)]",
